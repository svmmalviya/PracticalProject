...
namespace PracticalProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        private static List<InvItems> invItems = new List<InvItems>();
        ...
        public IActionResult Index(HomeViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //var productName = products.Where(x => x.ProductId == Guid.Parse(model.Pid)).FirstOrDefault().ProductName;

                //invItems.Add(new InvItems
                //{
                //    Customer = model.PartyName,
                //    Product = productName,
                //    ProductId = model.Pid,
                //    Qty = model.Qty,
                //    Rate = model.Rate,
                //    Amount = model.Qty * model.Rate,
                //});

                model = new HomeViewModel();
            }

            model.Items = invItems;
        ...
        public IActionResult RemoveItem(InvItems item, InvoiceEditModel invoice)
        {
